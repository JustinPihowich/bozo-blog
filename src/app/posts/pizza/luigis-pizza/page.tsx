...
export default function PizzeriaLolaPage() {
  return (
    <>
      <Image
        src="/pizza/luigis-pizza/images/luigis-logo.png"
        alt="Luigi's Pizza Logo"
        width={0}
        height={0}
        sizes="100vw"
      ...
      <Image
        src="/pizza/luigis-pizza/images/luigis-interior.jpg"
        alt="Luigi's Interior"
        width={0}
        height={0}
        sizes="100vw"
        style={{ width: 'auto', height: 'auto' }}
      ...
      <Image
        src="/pizza/luigis-pizza/images/luigis-my-pizza.jpg"
        alt="My Pizza"
        width={0}
        height={0}
        sizes="100vw"
